import {dataitems, getProduct} from '../../data/products.js';
...
export function renderOrderSummary() {
        ...
        cart.forEach((item) => {
            ...
            const itemOptionDay = getdeliveryOptions(itemdelivaryoptionid);
        ...
        .forEach((element) => {
            element.addEventListener('click', () => {
                // const productId = element.dataset.itemId;
                let {itemId, deliveryOptionId}= element.dataset;
                updateDelivaryOption(itemId, deliveryOptionId);
                renderOrderSummary();
                renderPaymentSummary();
            });
        });
